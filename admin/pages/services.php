...
?>
						...
						<tr>
							<td colspan="3" width="15%" ><h3>Buat Details Layanan (Services)</h3></td>
						</tr>
						<tr>
							<td align="left" colspan="3">
								<textarea id="isi_post" name='isi_post' ><?php 	echo $hasil['service']; ?></textarea>
							</td>
						</tr>
						<tr>
							<td align="left" colspan="3">
						...
						<input style="display:none;" type="text" name="category" value="service"/>
