...
<div id='container'>
	<div id='menu'>
		<ul class='top_menu'>
			...
			<a class='visit' href='news.php?ctr=0'><li>News</li></a> |
				...
				<td width='70%'>
					...
					<div class='news'>
						<?php
							...
							if($awal < 0){$awal=0;}
							$akhir = $awal+5;
							$qry_posting_news = "select * from tbl_posting where category='news' or category='artikel' order by id_post desc limit $awal,$akhir;";
					...
					<div>
						<hr/>
						<h3><a href='news.php?ctr=<?php echo $awal-5 ?>'>Prev</a> | <a href='news.php?ctr=<?php echo $akhir ?>'>Next</a></h3>
					</div>
				</td>
				<td width='30%'>
					<div>
