...
<div id='container'>
	<div id='menu'>
		<ul class='top_menu'>
			...
			<a class='visit' href='services.php'><li>Services</li></a> |
	...
	<div id='content'>
		<table id='content-spliter' cellspacing='20px'>
			<tr valign='top'>
				<td width='70%'>
					<h3 class='tag_title'><img src='../img/rule.gif'/>SERVICES</h3>
					<hr/><br/>
					<div class='news'>
						<?php
							//ini untuk ambil data service di tabel master  (tbl_master)
