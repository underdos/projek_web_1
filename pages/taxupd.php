...
<div id='container'>
	<div id='menu'>
		<ul class='top_menu'>
			...
			<a class='visit' href='taxupd.php?ctr=0'><li>Tax Update</li></a> |
	...
	<div id='content'>
		<table id='content-spliter' cellspacing='20px'>
			<tr valign='top'>
				<td width='70%'>
					<h3 class='tag_title'><img src='../img/rule.gif'/>NEWS & ARTIKEL</h3>
					<hr/><br/>
					<div class='news'>
						<?php
							...
							if($awal < 0){$awal=0;}
							$akhir = $awal+5;
							$qry_posting_news = "select * from tbl_posting where category='taxupd' or category='artikel' order by id_post desc limit $awal,$akhir;";
					...
					<div>
						<hr/>
						<h3><a href='taxupd.php?ctr=<?php echo $awal-5 ?>'>Prev</a> | <a href='taxupd.php?ctr=<?php echo $akhir ?>'>Next</a></h3>
					</div>
				</td>
				<td width='30%'>
					<div>
